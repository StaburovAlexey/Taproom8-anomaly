...
const messages = {
  ru: {
    ...
    game: {
      ...
      mistakeProtected: 'вы потратили шанс на ошибку',
    },
    boosts: {
      shopTitle: 'Улучшения',
      openShop: 'Улучшения',
      ...
      paymentsUnavailable: 'Покупки временно недоступны.',
      retry: 'Повторить',
      ...
      preparationDescription: 'Настройте улучшения перед началом прохождения.',
      mistakeChances: 'Шансы на ошибку',
      rewardLoading: 'Загрузка рекламы...',
      chancesFull: 'Все шансы получены',
      watchReward: 'Смотреть рекламу: +1 шанс',
      activeBoosts: 'Активные улучшения',
      purchaseRequired: 'Требуется покупка',
      startRun: 'Начать прохождение',
      chancesHud: 'Шансы',
      speedActive: 'Ускорение ×1.5',
    },
    interaction: {
  ...
  en: {
    ...
    game: {
      ...
      mistakeProtected: 'You missed the chance to make a mistake.',
    },
    boosts: {
      shopTitle: 'Upgrades',
      openShop: 'Upgrades',
      ...
      paymentsUnavailable: 'Purchases are temporarily unavailable.',
      retry: 'Retry',
      purchaseFailed: 'The purchase was not completed. Please try again.',
      extraChance: {
        title: 'Extra chance',
      },
      speed: {
      ...
      preparationDescription: 'Configure upgrades before starting.',
      mistakeChances: 'Mistake chances',
      rewardLoading: 'Loading ad...',
      chancesFull: 'All chances received',
      watchReward: 'Watch ad: +1 chance',
      activeBoosts: 'Active upgrades',
      purchaseRequired: 'Purchase required',
      startRun: 'Start playthrough',
      chancesHud: 'Chances',
      speedActive: 'Speed ×1.5',
    },
    interaction: {
